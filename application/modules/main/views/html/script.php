    ...
    <script src="<?=base_url()?>assets/main/js/contact-script.js"></script>
    <script src="<?=base_url()?>assets/main/js/hoverIntent.js"></script>
    <script src="<?=base_url()?>assets/main/js/superfish.min.js"></script>
    <script src="<?=base_url()?>assets/main/js/owl.carousel.js"></script>
    <script src="<?=base_url()?>assets/main/js/wow.min.js"></script>
    <script src="<?=base_url()?>assets/main/js/jquery.circliful.min.js"></script>
    <script src="<?=base_url()?>assets/main/js/waypoints.min.js"></script>
    <script src="<?=base_url()?>assets/main/js/jquery.slicknav.min.js"></script>
    <script src="<?=base_url()?>assets/main/js/retina.min.js"></script>
...
/* Τestimonials
   ========================================================================== */
    ...
    var planval = new Array('VPS1', 'VPS2', 'VPS3', 'VPS4', 'VPS5', 'VPS6'); //Hosting Plans Names. Displayed only to small screens
    var memoryval = new Array('1GB', '2GB', '3GB', '4GB', '5GB', '6GB'); //Memory array per plan
    var diskspaceval = new Array('100GB', '200GB', '300GB', '400GB', '500GB', '600GB'); //Disk Space array per plan
    var bandwidthval = new Array('1000GB', '2000GB', '3000GB', '4000GB', '5000GB', '6000GB'); //Bandwidth array per plan
    var decimalval = new Array('.00', '.00', '.00', '.00', '.00', '.00'); //Decimal array per plan

    var priceval = new Array('39', '79', '109', '139', '179', '209'); //Price array per plan
